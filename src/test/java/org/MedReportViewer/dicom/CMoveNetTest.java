...
import org.MedReportViewer.dicom.op.CMove;
import org.MedReportViewer.dicom.param.*;
...
public class CMoveNetTest {
  ...
  public void testProcess() {
    ...
    DicomState state = CMove.process(options, calling, called, "MedReportViewer-SCU", progress, params);
